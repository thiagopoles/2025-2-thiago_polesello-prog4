...
WHERE datahora BETWEEN '2025-01-01' AND '2025-01-31';
...
FROM mabel_ptqa_heitor_isabely_thiago.leituramabel
WHERE DATE(datahora) = '2025-01-15';
...
SELECT *
FROM mabel_ptqa_heitor_isabely_thiago.leituraptqa
WHERE AQI >= 4 AND datahora BETWEEN '2025-01-01' AND '2025-01-31';

-- 19
SELECT *
FROM mabel_ptqa_heitor_isabely_thiago.leituraptqa
WHERE umidade > 70 AND datahora BETWEEN '2025-01-01' AND '2025-01-31'
ORDER BY umidade DESC;

-- 20
SELECT *
FROM mabel_ptqa_heitor_isabely_thiago.leituraptqa
WHERE co2 > 1000 AND datahora BETWEEN '2025-01-01' AND '2025-01-31';

-- 21
SELECT *
FROM mabel_ptqa_heitor_isabely_thiago.leituraptqa
WHERE pressao < 1000 AND datahora BETWEEN '2025-01-01' AND '2025-01-31';

-- 22
SELECT *
FROM mabel_ptqa_heitor_isabely_thiago.leituraptqa
WHERE gases_volateis > 200 AND datahora BETWEEN '2025-01-01' AND '2025-01-31';
...
SELECT *
FROM mabel_ptqa_heitor_isabely_thiago.leituraptqa
WHERE AQI = 1 AND datahora BETWEEN '2025-01-01' AND '2025-01-31';
