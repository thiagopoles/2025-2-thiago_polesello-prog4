...
function chamarBackend() {
    ...
    let url = `http://localhost/2025-2-thiago_polesollo-prog4/PHP/consultasPTQA/BaixaQualidadeDoArAQI.php?dataInicial=${valorDataInicial}&dataFinal=${valorDataFinal}`;
